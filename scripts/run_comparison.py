...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--algorithm", choices=["umda", "umda_structured"], required=True)
    ...
    parser.add_argument("--domain-size", type=int, default=250)
    parser.add_argument("--ignore-price", action="store_true")
...
def main() -> int:
    ...
    if args.algorithm in {"umda", "umda_structured"}:
        rows = run_umda_experiment(
            ...
            ignore_price=args.ignore_price,
        )
    else:
